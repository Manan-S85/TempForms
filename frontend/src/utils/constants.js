...
export const EXPIRATION_OPTIONS = [
  ...
  },
  {
    value: '30min',
    label: '30 Minutes',
    description: 'Great for short surveys and feedback',
    duration: 30 * 60 * 1000,
    popular: true,
  },
  {
    value: '1hour',
    label: '1 Hour',
    description: 'Ideal for class surveys or event feedback',
    duration: 60 * 60 * 1000,
    popular: true,
  },
  {
    value: 'custom',
    label: 'Custom Time',
    description: 'Set your own expiration time (1 min - 24 hours max)',
    duration: null,
    popular: false,
  },
];
